Shader "Ground/BlendingTextures_alpha" {
Properties {
...
SubShader {
	Tags {
		"SplatCount" = "4" "Queue" = "Geometry+300" "IgnoreProjector"="false" "RenderType"="opaque"
	}
	LOD 300
CGPROGRAM
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.Albedo = col;
	float alpha = splat_control.b * tex2D (_Splat2, IN.uv_Splat2).a;
	alpha += splat_control.g * tex2D (_Splat1, IN.uv_Splat1).a;
	alpha += splat_control.r * tex2D (_Splat0, IN.uv_Splat0).a;
	o.Alpha = alpha;
}
ENDCG  
}
